...
## ![Problem Statement](https://ubc-stat.github.io/stat-201/group-project.html)

Sourced from UBC STAT 201 website:
...
- Selected a group of datasets to conduct statistical inference analysis on variations in PM2.5 concentrations across 5 cities, and demonstrated that the datasets can be read from the web into R.
...
- Conducted hypothesis tests for the statistical significance of differences in PM2.5 concentrations between 2013 and 2015, and their identified implications.
